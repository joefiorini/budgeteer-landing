...
const benefits =
  ...
  , { title: 'Assign every dollar to a goal'
    , description: 'Curb impulsive spending with realistic thinking; put everything towards your goals to make sure you achieve them'
    }
  ...
  , { title: 'Communicate on your own schedule'
    , description: 'Flag items, leave notes or questions for others to respond to when it’s convenient for them'
    }
